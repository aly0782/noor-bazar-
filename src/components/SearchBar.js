...
function SearchBar({ searchTerm, onSearchChange, categoryFilter, onCategoryChange, priceRange, onPriceRangeChange, sortBy, onSortChange, viewMode, onViewModeChange }) {
  return (
    <div className="bg-white rounded-xl shadow-md p-4 mb-6 animate-fadeIn">
      {/* Search Input */}
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-noor-gold focus:border-transparent text-sm"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          <input
            ...
            className="w-24 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-noor-gold"
          />
        ...
        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden ml-auto">
          <button
            ...
            className={`p-2 ${viewMode === 'grid' ? 'bg-noor-gold text-noor-dark' : 'text-gray-500 hover:bg-gray-100'}`}
          >
          ...
          <button
            ...
            className={`p-2 ${viewMode === 'list' ? 'bg-noor-gold text-noor-dark' : 'text-gray-500 hover:bg-gray-100'}`}
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
